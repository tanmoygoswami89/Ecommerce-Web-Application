    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="">
                    <h4>Cenizas Men's Full Sleeves Solid Stripes Round Neck Tshirt</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                ...
                <a href="">
                    <h4>Men Navy Solid Polo Collar T-shirt</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                ...
                <a href="">
                    <h4>Men Beige Colourblocked Raw Edge Round Neck T-shirt</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                ...
                <a href="">
                    <h4>Pause Men Black Slim fit Cotton Blend Round neck T-Shirt</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
